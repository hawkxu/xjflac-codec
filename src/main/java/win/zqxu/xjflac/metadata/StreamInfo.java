...
public class StreamInfo extends Metadata {
  ...
  /**
   * Check for compatiable StreamInfo. Checks if sampleRate, channels, and
  ...
  public AudioFormat getAudioFormat() {
    return new AudioFormat(sampleRate, bitsPerSample, channels, (bitsPerSample <= 8) ? false : true,
        false);
  }
