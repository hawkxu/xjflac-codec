...
public class CueSheet extends Metadata {
  ...
  protected boolean isCD = false; // true if CUESHEET corresponds to a Compact
                                  // Disc, else false
  protected int numTracks = 0; // The number of tracks.
  protected CueTrack[] tracks; // NULL if num_tracks == 0, else pointer to array
                               // of tracks.
