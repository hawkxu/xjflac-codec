...
public class FlacAudioFormat extends AudioFormat {
  ...
  /**
   * Property key for minimum frame size. The value is of type Integer and gives
   * the minimum size of encoded frames in bytes.
   */
  public static final String KEY_FRAMESIZE_MIN = "framesize_min";
  /**
   * Property key for maximum frame size. The value is of type Integer and gives
   * the maximum size of encoded frames in bytes.
   */
  public static final String KEY_FRAMESIZE_MAX = "framesize_max";
  /**
   * Property key for minimum block size. The value is of type Integer and gives
   * the minimum size of decoded frames in bytes.
   */
  public static final String KEY_BLOCKSIZE_MIN = "blocksize_min";
  /**
   * Property key for maximum block size. The value is of type Integer and gives
   * the maximum size of decoded frames in bytes.
   */
  ...
  /**
   * Java 5.0 compatible method to get a property. As key use the KEY_ constants
